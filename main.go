...
func main() {
	...
	if errDb != nil {
		log.Fatalf("Failed to connect to databases %s: %v", config.DB_PATH.GetValue(), errDb)
	}
	...
	route.Get("/metrics", monitor.New(monitor.Config{Title: "Hioto Fiber Metrics Page"}))
